...
t 												<tr>
t 													<td>  Allumer Phares ? </td>
t 													<td><table><tr valign="middle">
c d 0 <td><input type=checkbox name=led0 value=1 %s id="switch"><label for="switch">LED0</label></td>
t 														</tr>
t 													</font></table>
t 													</td>
t 												</tr>
t 												<tr>
t 													<td>  Allumer Cligno Droite ? </td>
t 													<td><table><tr valign="middle">
c e 0 <td><input type=checkbox name=cliD value=1 %s>Activé</td>
t 														</tr>
t 													</font></table>
t 													</td>
t 												</tr>
t 												<tr>
t 													<td>  Allumer Cligno Gauche ? </td>
t 													<td><table><tr valign="middle">
c f 0 <td><input type=checkbox name=cliG value=1 %s>Activé</td>
t 														</tr>
t 													</font></table>
t 													</td>
t 												</tr>
